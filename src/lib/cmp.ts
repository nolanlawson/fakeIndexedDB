 ...
 */
export const cmpKeysBaseline = (first: any, second: any): -1 | 0 | 1 => {
...
export const cmpBaseline = (first: any, second: any): -1 | 0 | 1 => {
    if (second === undefined) {
        throw new TypeError();
    }

    return cmpKeysBaseline(valueToKey(first), valueToKey(second));
};
